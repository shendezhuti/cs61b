...
public class HashTableChained1 implements Dictionary {
  ...
  public HashTableChained1(int sizeEstimate) {
    // Your solution here.
 ...
 public String[] String() {
  ...
  public static void main (String []args){
    HashTableChained1 table=new HashTableChained1(100);
